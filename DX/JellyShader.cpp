...
JellyShader::JellyShader(ID3D11Device* device, HWND hwnd) : BaseShader(device, hwnd)
{
	InitShader(L"../shaders/jelly_vs.hlsl", L"../shaders/jelly_ps.hlsl");
}

JellyShader::~JellyShader()
{
...
void JellyShader::InitShader(WCHAR* vsFilename, WCHAR* psFilename)
{
...
void JellyShader::SetShaderParameters( ID3D11DeviceContext* deviceContext,
...
void JellyShader::Render(ID3D11DeviceContext* deviceContext, int indexCount)
{
