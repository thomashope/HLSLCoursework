...
BlendShader::BlendShader(ID3D11Device* device, HWND hwnd) : BaseShader(device, hwnd)
{
	InitShader(L"../shaders/texture_vs.hlsl", L"../shaders/blend_ps.hlsl");
}
...
void BlendShader::InitShader(WCHAR* vsFilename, WCHAR* psFilename)
{
