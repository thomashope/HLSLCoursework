...
TessNormalShader::TessNormalShader(ID3D11Device* device, HWND hwnd) : BaseShader(device, hwnd)
{
	InitShader(	L"../shaders/tessellation_vs.hlsl",
				L"../shaders/tessellation_hs.hlsl",
				L"../shaders/tessnormal_ds.hlsl",
				L"../shaders/tessnormal_ps.hlsl" );
}


TessNormalShader::~TessNormalShader()
{
...
void TessNormalShader::InitShader(WCHAR* vsFilename,  WCHAR* psFilename)
{
...
void TessNormalShader::InitShader(WCHAR* vsFilename, WCHAR* hsFilename, WCHAR* dsFilename, WCHAR* psFilename)
{
...
void TessNormalShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX &worldMatrix, const XMMATRIX &viewMatrix, const XMMATRIX &projectionMatrix, ID3D11ShaderResourceView* texture, float tesselationFactor, float time)
{
	HRESULT result;
...
void TessNormalShader::Render(ID3D11DeviceContext* deviceContext, int indexCount)
{
